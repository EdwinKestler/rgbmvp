...
| **Status** | **P0–P3 closed** · **S3** + **C2** done · next: **C4** stake · public demo only after **U4** ([ROADMAP_NEXT](docs/ROADMAP_NEXT.md)) |
...
| **Next work** | [docs/ROADMAP_NEXT.md](docs/ROADMAP_NEXT.md) — C4 stake · U4 before public Internet · [C2_CLOSED](docs/C2_CLOSED.md) · [S3_RGB_WRAP](docs/S3_RGB_WRAP.md) |
